...
conflicts :: [Point]
conflicts = HashSet.toList $ HashSet.delete (0,0) $ HashSet.intersection (HashSet.fromList path1) (HashSet.fromList path2)
    where 
        (path1, path2) = toplot
